all : ex_k4_worst_case ex_k5_worst_case ex_k4_random ex_k5_random ex ex_parallel ex_k4_extra_cnot_layers
...
ex_k4_extra_cnot_layers : sim_k4_extra_cnot_layers.cpp $(DEPS)
	${CC} ${CFLAGS} sim_k4_extra_cnot_layers.cpp -o $@ -lpthread

clean :
	rm ex ex_parallel ex_k4_worst_case ex_k5_worst_case ex_k4_random ex_k5_random ex_k4_extra_cnot_layers
