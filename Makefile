all : ex_k4_worst_case ex_k5_worst_case ex_k4_random ex_k5_random ex ex_parallel
...
clean :
	rm ex ex_parallel ex_k4_worst_case ex_k5_worst_case ex_k4_random ex_k5_random
